  ...
  <tr>
    ...
    <td style="vertical-align:top;padding:12px 12px 12px 0;">
      ...
      <div style="margin-top:6px;font-size:13px;color:#666;">
        ${movie.gross ? `<span style="color:#16a34a;font-weight:700;">${formatCurrency(movie.gross)}</span>` : `<span style="color:#16a34a;font-weight:700;">${formatCurrency(movie.revenue)}</span>`}
